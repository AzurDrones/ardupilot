...
const AP_Param::GroupInfo SITL::var_info2[] = {
    ...
    AP_SUBGROUPINFO(sprayer_sim, "SPR", 14, SITL, Sprayer),
    AP_SUBGROUPINFO(gripper_sim, "GRP", 15, SITL, Gripper_Servo),
    AP_SUBGROUPINFO(gripper_epm_sim, "GRP", 16, SITL, Gripper_EPM),
