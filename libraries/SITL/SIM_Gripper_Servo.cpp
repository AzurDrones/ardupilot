...
const AP_Param::GroupInfo Gripper_Servo::var_info[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO_FLAGS("_ENABLE",  0, Gripper_Servo,  gripper_enable, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @Range: 0 15
    // @User: Advanced
    AP_GROUPINFO("_PIN",    1, Gripper_Servo,  gripper_servo_pin, -1),
 ...
 */
void Gripper_Servo::update(int16_t gripper_pwm, bool on_ground)
{
